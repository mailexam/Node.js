...
Minimal [Node.js](https://nodejs.org/) example (built-in [`http`](https://nodejs.org/api/http.html) module, no web framework) that sends test mail through [Mailexam](https://mailexam.ru/) SMTP via [Nodemailer](https://nodemailer.com/).
